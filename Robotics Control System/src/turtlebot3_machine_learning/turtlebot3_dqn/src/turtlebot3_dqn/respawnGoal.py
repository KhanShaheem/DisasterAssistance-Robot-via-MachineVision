...
class Respawn():
    def __init__(self):
        ...
        self.init_goal_x =  1    #0.6[3.5, -3.5, -2.4, 4.4]
        self.init_goal_y =  0     #0.0[-3.0, -3.5, 3.4, 3.5]
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            ...
            while position_check:
                ...
                self.goal_position.position.x = 4.37#goal_x_list[self.index]
                self.goal_position.position.y = 3.47#goal_y_list[self.index]
